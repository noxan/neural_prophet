...
def test_normalize():
    ...
    # with config
    m.config_normalization.init_data_params(df, m.config_covar, m.config_future_regressors, m.config_events)
    ...
    local_data_params, global_data_params = df_utils.init_data_params(
        ...
        config_future_regressors=m.config_future_regressors,
...
def test_globaltimedataset():
    ...
    for m in [m1, m2, m3]:
        ...
        config_normalization.init_data_params(df_global, m.config_covar, m.config_future_regressors, m.config_events)
    ...
    for m in [m4]:
        df4
        config_normalization.init_data_params(df4, m.config_covar, m.config_future_regressors, m.config_events)
        m.config_normalization = config_normalization
